// src/components/navbar/ServiceDropdown.tsx
"use client";
...
const ServiceDropdown: React.FC<ServiceDropdownPropsExtended> = ({
  ...
  return (
    <motion.div
      // ✅ POPRAWKA: max-h-[75vh] i overflow-y-auto naprawia problem uciekania poza ekran
      className="absolute top-full left-0 mt-2 w-80 bg-background border-4 border-foreground rounded-md shadow-[8px_8px_0px_0px_theme(colors.foreground)] z-50 max-h-[75vh] overflow-y-auto custom-scrollbar"
    ...
    >
      <div className="p-6">
        <div className="flex items-center gap-2 mb-4 text-primary font-primary font-medium sticky top-0 bg-background z-10 pb-2 border-b-2 border-transparent">
        ...
        <motion.div
          className="mt-4 pt-4 border-t-2 border-foreground sticky bottom-0 bg-background pb-2"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
